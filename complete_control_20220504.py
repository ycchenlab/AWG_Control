...
# to drive the bi-axial AOD. The information of the signal waveform is input to the program as an external .txt file.
...
# set samplerate, no clock output
...
llLoops = int64 (0) # number of loops, 0 means continuously
...
qwBufferSize = uint64 (llMemSamples.value * lBytesPerSample.value * .value)
