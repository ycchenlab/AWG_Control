...
int_ref = 167.448
attempt = 1
# im = np.array(Image.open(f'IntOptD/example_{attempt}.png'))[450:510, 640-180:640+180]
im = np.array(Image.open(f'IntOptD/example_r.png'))[450:510, 640-180:640+180]
...
positions = np.delete(positions, 6, 0)
positions = np.delete(positions, 3, 0)
positions = np.delete(positions, 1, 0)
ntrap = 4
